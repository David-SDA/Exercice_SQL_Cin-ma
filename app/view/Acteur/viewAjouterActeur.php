...
?>
    ...
    <div class=formulaire>
        ...
        <form enctype='multipart/form-data' action="index.php?action=ajouterActeur" method="post">
            ...
            <div class="nomChamp">
                <label for="estRealisateur">Est-il aussi réalisateur ?</label>
                <input type="radio" name="estRealisateur" id="Oui" value="Oui">
                <label for="Oui">Oui</label>
                <input type="radio" name="estRealisateur" id="Non" value="Non" checked>
